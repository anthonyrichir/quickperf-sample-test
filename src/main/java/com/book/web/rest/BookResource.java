...
/**
 * REST controller for managing {@link com.book.domain.Book}.
 */
@RestController
@RequestMapping("/api")
public class BookResource {
    ...
    private static final String ENTITY_NAME = "bookApiBook";
     ...
     */
    @GetMapping("/books")
    public ResponseEntity<List<Book>> getAllBooks(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
