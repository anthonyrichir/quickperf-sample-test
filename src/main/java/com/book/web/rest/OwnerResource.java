...
import com.book.domain.Owner;
import com.book.repository.OwnerRepository;
...
/**
 * REST controller for managing {@link com.book.domain.Owner}.
 */
@RestController
@RequestMapping("/api")
public class OwnerResource {
    ...
    private static final String ENTITY_NAME = "bookApiOwner";
